                ...
                <tbody>
                    ...
                    foreach ($results as $result) {
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo site_url(); ?>/manufacture/manage_manufactures"><i class="glyph-icon tooltip-button demo-icon icon-pencil" title="" data-original-title="Update"></i></a>
