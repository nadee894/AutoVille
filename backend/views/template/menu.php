<ul id="sidebar-menu">
    <li class="header"><span>Vehicle Specifications</span></li>
    <li>
        <a href="<?php echo site_url(); ?>/transmission/manage_transmissions" title="Transmissions">
...
<!--    <li class="no-menu">
        <a href="http://demo.agileui.com/monarch/demo/frontend-template/index.html" title="Frontend template">
