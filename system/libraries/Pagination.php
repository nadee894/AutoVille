...
class CI_Pagination {
	...
	var $cur_tag_open		= '<a class="current-item">';
	var $cur_tag_close		= '</a>';
	var $next_tag_open		= '<span class="first paginate_button">';
	var $next_tag_close		= '</span>';
	var $prev_tag_open		= '<span class="first paginate_button">';
	var $prev_tag_close		= '</span>';
	var $num_tag_open		= '<span class="paginate_button">';
