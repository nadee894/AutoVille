    ...
    <aside class="profile-nav col-lg-3">
        <section class="panel">
            ...
            <ul class="nav nav-pills nav-stacked">
                <li class="active" ><a href="<?php echo site_url(); ?>/reg_user_profile/load_profile_of_reg_user" > <i class="fa fa-user"></i> Profile</a></li>
                ...
                <li><a onclick="load_reg_user_edit_profile()"> <i class="fa fa-edit"></i> Edit profile</a></li>
            </ul>
...
//            data: "myletter=" + letter,
    ...
    //load registered user edit profile 
    function load_reg_user_edit_profile(){
        
        $.ajax({
            type: "POST", 
            url: site_url + '/reg_user_profile/load_reg_user_edit_profile',
            success: function(msg)
            {
                $('#reg_user_activities_filter_content').html(msg);
            }
        });
