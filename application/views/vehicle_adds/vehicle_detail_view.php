                ...
                <div class="car-full-specs one-half col-460">
                    ...
                    <ul class="car-specs-list">
                        <li>
                            ...
                            <span class="value"><?php echo $vehicle_detail->model . ' , ' . $vehicle_detail->body_type; ?></span>
                        </li>
                        <li>
                        ...
                        <li>
                            ...
                            <span class="value"><?php echo $vehicle_detail->chassis_no; ?></span>
                        </li>
                        <li>
                        ...
                        <li>
                            ...
                            <span class="value"><?php echo $vehicle_detail->kilometers; ?> km</span>
                        </li>
                    </ul>
